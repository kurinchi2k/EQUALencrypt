...
Instructions <- {paste0(
  ...
  "<ol start = 1>",
  "<li>This program has been created for sharing research data and documents which are in tabular, image, word, or pdf format.</li>",
  "<li>The user must use this software at their own risk.</li>",
